...
• This project also prepares me to teach beginners how machine learning models learn patterns from data.

# What I Learned
• How to load and preprocess image datasets
•The difference between traditional ML models (scikit-learn) and neural networks (PyTorch & TensorFlow)
• How backpropagation and gradient descent optimize model parameters
• How to evaluate model performance using accuracy metrics
 •How frameworks differ in training loops (fit() in Keras vs manual loop in PyTorch)
